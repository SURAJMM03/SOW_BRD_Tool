...
from agents.brd_agent.agents.dp_agent import create_generation_agent
...
def generate_dp_sections_from_qa(qa_records: list, research_context: str = "") -> dict:
    """
    Generate sections 4, 4.1, 4.2, 4.2.1, 4.2.2.
    ...
    if _single_match:
        ...
        gen_prompt = (
            ...
            "You are a senior Blueprint Document writer for enterprise solution "
            "implementations at Bristlecone.\n\n"
            "TASK: Generate sections 4, 4.1, 4.2, 4.2.1, 4.2.2 for the Blueprint Document.\n\n"
            "RULES:\n"
            ...
            "5. Output ONLY <SECTION id=\"X\">...</SECTION> blocks - nothing else.\n\n"
            "RESEARCH CONTEXT:\n"
            f"{research_context or 'No context provided.'}\n\n"
            "Generate sections 4, 4.1, 4.2, 4.2.1, 4.2.2 using <SECTION id=\"X\"> tags only."
        )
