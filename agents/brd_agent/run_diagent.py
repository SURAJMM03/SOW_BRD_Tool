...
from agents.brd_agent.agents.di_agent import create_generation_agent
...
def generate_di_sections_from_qa(qa_records: list, research_context: str = "") -> dict:
    """
    Generate sections 6, 6.1, 6.2, 6.3, 6.4.
    ...
    if _single_match:
        ...
        gen_prompt = (
            ...
            "You are a senior Blueprint Document writer for enterprise solution "
            "implementations at Bristlecone.\n\n"
            "TASK: Generate sections 6, 6.1, 6.2, 6.3, 6.4 for the Blueprint Document.\n\n"
            "RULES:\n"
            ...
            "RESEARCH CONTEXT:\n"
            f"{research_context or 'No context provided.'}\n\n"
            "Generate sections 6, 6.1, 6.2, 6.3, 6.4 using <SECTION id=\"X\"> tags only."
        )
