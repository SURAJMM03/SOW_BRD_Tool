...
from agents.brd_agent.agents.ip_agent import create_generation_agent
...
def generate_ip_sections_from_qa(qa_records: list, research_context: str = "") -> dict:
    """
    Generate sections 5, 5.1, 5.2, 5.3, 5.4.
    ...
    if _single_match:
        ...
        gen_prompt = (
            ...
            "You are a senior Blueprint Document writer for enterprise solution "
            "implementations at Bristlecone.\n\n"
            "TASK: Generate sections 5, 5.1, 5.2, 5.3, 5.4 for the Blueprint Document.\n\n"
            "RULES:\n"
            ...
            "RESEARCH CONTEXT:\n"
            f"{research_context or 'No context provided.'}\n\n"
            "Generate sections 5, 5.1, 5.2, 5.3, 5.4 using <SECTION id=\"X\"> tags only."
        )
